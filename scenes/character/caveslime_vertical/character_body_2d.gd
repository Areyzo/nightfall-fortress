...
@onready var hp_bar = $Hp_slime_vertical  # Correct name from scene
...
func take_damage(amount):
	...
	print("Vertical Slime took ", amount, " damage! Current HP: ", health)
	update_health_bar()
...
func update_health_bar():
	if hp_bar != null:
		print("Updating vertical slime health bar - Current HP: ", health, " Max HP: ", max_health)
		...
		hp_bar.visible = true
		print("Vertical Slime health bar updated: ", health_percentage, "%")
	else:
		print("ERROR: Vertical slime hp_bar is null!")
